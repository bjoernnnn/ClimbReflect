...
> ⚠️ **Aktualisierte Schuh-Regeln** in `TODO-ANALYTICS-TRAINING.md` → Abschnitt „Schuh-Verfeinerung"
> beachten: **kein „Keiner"** mehr (immer genau ein Schuh aktiv, Fallback „Eigener Schuh"), plus
> **Standard-Schuh je Kletterart** (Mehrfachauswahl). Diese Regeln gehen SH-1/SH-2/SH-3/SH-7/SH-8/SH-9 vor.
